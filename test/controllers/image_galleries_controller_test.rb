...
class ImageGalleriesControllerTest < ActionController::TestCase
  ...
  test "should create image_gallery" do
    assert_difference('ImageGallery.count') do
      post :create, image_gallery: { category: @image_gallery.category, description: @image_gallery.description, title: @image_gallery.title }
    end
  ...
  test "should update image_gallery" do
    patch :update, id: @image_gallery, image_gallery: { category: @image_gallery.category, description: @image_gallery.description, title: @image_gallery.title }
    assert_redirected_to image_gallery_path(assigns(:image_gallery))
  end
